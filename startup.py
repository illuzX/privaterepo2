...
Iam [𝐅𝐢𝐥𝐭𝐞𝐫 𝐛𝐨𝐭 𝐯𝟐](t.me/{bot_username}) 
...
𝐅𝐨𝐫 𝐌𝐨𝐫𝐞 𝐃𝐞𝐭𝐚𝐢𝐥𝐬 𝐂𝐥𝐢𝐜𝐤 help"""
    ...
    HELP_MSG = """**
𝐇𝐲 👋  {mention}\n
𝐈 𝐂𝐚𝐧 𝐏𝐫𝐨𝐯𝐢𝐝𝐞 𝐌𝐨𝐯𝐢𝐞𝐬 𝐉𝐮𝐬𝐭 𝐓𝐲𝐩e a 𝐌𝐨𝐯𝐢𝐞 𝐍𝐚𝐦𝐞\n
𝐀𝐧𝐝 𝐒𝐞𝐞 𝐓𝐡𝐚 𝐌𝐚𝐠𝐢𝐜 ✨"""
    DISCLAIMER = """
⚠️𝘿𝙄𝙎𝘾𝙇𝘼𝙄𝙈𝙀𝙍📍
...
|
|○📚𝐋𝐚𝐧𝐠𝐮𝐚𝐠𝐞 : [𝐏𝐲𝐭𝐡𝐨𝐧 𝟑.10.2](https://www.python.org/)
|
|○🔧𝐅𝐫𝐚𝐦𝐞𝐰𝐨𝐫𝐤 : [𝐏𝐲𝐫𝐨𝐠𝐫𝐚𝐦 𝟏.𝟒.9](https://docs.pyrogram.org/)
|
|○⚠️𝐂𝐡𝐚𝐧𝐧𝐞𝐥 : [𝐔𝐳𝕏_𝐁𝐨𝐭𝐬](https://t.me/UZX_BOTS)     
|
|○⭐ 𝐃𝐚𝐭𝐚𝐁𝐚𝐬𝐞:[𝐌𝐎𝐍𝐆𝐎𝔻𝔹](https://mongodb.com)
|
|○💡𝐒𝐨𝐮𝐫𝐜𝐞𝐂𝐨𝐝𝐞: [𝐂𝐥𝐢𝐜𝐤 𝐦𝐞⭐](https://www.github.com/illuzX/AtwFilt)
|____
